...
export function InternetStatusAlert() {
    ...
    return (
        <div className="fixed top-0 left-0 right-0 z-[100] p-4 animate-in slide-in-from-top duration-300">
            <Alert variant="destructive" className="max-w-2xl mx-auto shadow-2xl border-2 border-red-600 bg-red-950/90 backdrop-blur-sm text-white">
